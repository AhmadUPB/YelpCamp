...
<div align="center">
  <img src="https://github.com/AhmadUPB/YelpCamp/blob/master/views/main_page.png" alt="main page"  style="width: 80%; margin: 20px;">
...
- **Ad Creation:** Users can create new campground ads by providing pictures, a description, and a price.
  ...
  <div align="center">
  <img src="https://github.com/AhmadUPB/YelpCamp/blob/master/views/new_campground.png" alt="create new campground"  style="width: 80%; margin: 20px;">
...
- **Review System:** Users can add reviews to ads, helping others make informed decisions about renting campgrounds.
  ...
  <div align="center">
  <img src="https://github.com/AhmadUPB/YelpCamp/blob/master/views/view_campground.png" alt="review campground"  style="width: 80%; margin: 20px;">
...
- **Map Integration:** A map is displayed when searching for campgrounds, showing the locations of the listed campgrounds.
  ...
  <div align="center">
  <img src="https://github.com/AhmadUPB/YelpCamp/blob/master/views/map_campgrounds.png" alt="view campgrounds"  style="width: 80%; margin: 20px;">
...
- **Authentication and Authorization System:** Only users who created specific ads or reviews can modify them, ensuring content integrity.
  ...
  <div align="center">
  <img src="https://github.com/AhmadUPB/YelpCamp/blob/master/views/login.png" alt="login"  style="width: 80%; margin: 20px;">
